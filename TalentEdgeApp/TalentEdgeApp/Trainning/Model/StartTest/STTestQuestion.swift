...
public final class STTestQuestion: NSCoding {
  ...
  // MARK: Properties
  public var questionOption: [STQuestionOption]?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.questionOption].array { questionOption = items.map { STQuestionOption(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.questionOption = aDecoder.decodeObject(forKey: SerializationKeys.questionOption) as? [STQuestionOption]
