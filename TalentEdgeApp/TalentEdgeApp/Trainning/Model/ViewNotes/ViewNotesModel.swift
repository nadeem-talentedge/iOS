...
public final class ViewNotesModel: NSCoding {
  ...
  public var userContentView: UserContentView?
  ...
  public required init(json: JSON) {
    if let items = json[SerializationKeys.note].array { note = items.map { Note(json: $0) } }
    ...
    userContentView = UserContentView(json: json[SerializationKeys.userContentView])
    ...
    basePath = json[SerializationKeys.basePath].string
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = note { dictionary[SerializationKeys.note] = value.map { $0.dictionaryRepresentation() } }
    ...
    if let value = basePath { dictionary[SerializationKeys.basePath] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.note = aDecoder.decodeObject(forKey: SerializationKeys.note) as? [Note]
    ...
    self.userContentView = aDecoder.decodeObject(forKey: SerializationKeys.userContentView) as? UserContentView
    ...
    self.basePath = aDecoder.decodeObject(forKey: SerializationKeys.basePath) as? String
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(basePath, forKey: SerializationKeys.basePath)
