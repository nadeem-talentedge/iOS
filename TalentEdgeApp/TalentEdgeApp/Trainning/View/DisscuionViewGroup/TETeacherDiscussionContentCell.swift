...
protocol TETeacherDiscussionContentCellDelegate {
    
    func rightClickModuleList(indexPath : IndexPath?) -> Void
}
class TETeacherDiscussionContentCell: BCUITableViewCell {
    ...
    static let reuseIdentifier = "kTETeacherDiscussionContentCell"
    static let nibName = "TETeacherDiscussionContentCell"
