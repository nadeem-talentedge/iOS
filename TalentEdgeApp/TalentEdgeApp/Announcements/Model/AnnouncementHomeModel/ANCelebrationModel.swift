...
public final class ANCelebrationModel: NSCoding {
  ...
  public var eventDetails: [ANEventDetails]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.eventDetails].array { eventDetails = items.map { ANEventDetails(json: $0) } }
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = eventDetails { dictionary[SerializationKeys.eventDetails] = value.map { $0.dictionaryRepresentation() } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.eventDetails = aDecoder.decodeObject(forKey: SerializationKeys.eventDetails) as? [ANEventDetails]
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(eventDetails, forKey: SerializationKeys.eventDetails)
