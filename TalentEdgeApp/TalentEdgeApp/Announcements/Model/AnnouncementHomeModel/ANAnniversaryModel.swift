...
public final class ANAnniversaryModel: NSCoding {
  ...
  private struct SerializationKeys {
    ...
    static let anniversaryLogo = "anniversary_logo"
  ...
  public var anniversaryLogo: String?
  ...
  public required init(json: JSON) {
    ...
    anniversaryLogo = json[SerializationKeys.anniversaryLogo].string
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = anniversaryLogo { dictionary[SerializationKeys.anniversaryLogo] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.anniversaryLogo = aDecoder.decodeObject(forKey: SerializationKeys.anniversaryLogo) as? String
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(anniversaryLogo, forKey: SerializationKeys.anniversaryLogo)
