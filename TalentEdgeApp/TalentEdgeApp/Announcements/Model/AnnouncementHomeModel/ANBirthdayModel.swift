...
public final class ANBirthdayModel: NSCoding {
  ...
  private struct SerializationKeys {
    ...
    static let birthdayLogo = "birthday_logo"
    static let id = "id"
  ...
  public var birthdayLogo: String?
  ...
  public required init(json: JSON) {
    ...
    birthdayLogo = json[SerializationKeys.birthdayLogo].string
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = birthdayLogo { dictionary[SerializationKeys.birthdayLogo] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.birthdayLogo = aDecoder.decodeObject(forKey: SerializationKeys.birthdayLogo) as? String
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(birthdayLogo, forKey: SerializationKeys.birthdayLogo)
