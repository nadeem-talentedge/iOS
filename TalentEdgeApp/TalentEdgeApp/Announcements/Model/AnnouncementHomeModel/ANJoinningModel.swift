...
public final class ANJoinningModel: NSCoding {
  ...
  private struct SerializationKeys {
    ...
    static let joiningLogo = "joining_logo"
  ...
  public required init(json: JSON) {
    ...
    joiningLogo = json[SerializationKeys.joiningLogo].string
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = joiningLogo { dictionary[SerializationKeys.joiningLogo] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.joiningLogo = aDecoder.decodeObject(forKey: SerializationKeys.joiningLogo) as? String
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(joiningLogo, forKey: SerializationKeys.joiningLogo)
